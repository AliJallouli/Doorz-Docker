...
import { ConfirmEmailRequestDTO } from '../../../models/invite.models';
...
@Component({
  ...
  imports: [NgClass, NgIf, TranslateModule, ReactiveFormsModule, EmailInputComponent]
})
export class ConfirmEmailComponent implements OnInit, OnDestroy {
  ...
  fieldError: { [key: string]: string } = {}; // Ajout de fieldError
  validationTriggered = false; // Ajout de validationTriggered
